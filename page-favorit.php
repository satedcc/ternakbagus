                                ...
                                <div class="content-utama">
                                    <div class="iklan-header p-3">
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-auto">
                                                <span class="py-2 px-3 bg-warning text-white rounded">TERJUAL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="m-0">
                                    ...
                                    <div class="iklan-tombol p-3 d-md-flex justify-content-end">
                                        <div class="w-50 text-right">
                                            <a href="" class="btn btn-danger block w-100 f-12"><i class="far fa-trash-alt mr-2"></i>Delete Iklan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
