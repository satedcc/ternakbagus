...
if (isset($_SESSION['id'])) {
    ...
    $lokasi = $wpdb->get_row("SELECT id_prov,id_kab,id_kec, provinsi.nama AS nama_prov, kabupaten.nama AS nama_kab, kecamatan.nama AS nama_kec FROM provinsi LEFT JOIN kabupaten using (id_prov) 
                                ...
                                WHERE id_kec='" . $edit['lokasi'] . "'", ARRAY_A);
                ...
                <div class="col-md-9">
                    ...
                    ?>
                        <div class="alert alert-danger" role="alert">
                            <i class="far fa-bell-exclamation mr-3"></i> Iklan Gagal Tersimpan
                        </div>
                    <?php
                    }
                    ...
                    <div class="dashboard-content">
                        ...
                        <div class="dashboard-body">
                            <h1 class="f-20 bold-md">PASANG IKLAN TERNAK</h1>
                            <div class="form-iklan">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-input w-50">
                                        <label for="" class="bold-sm m-0 my-2">Berat</label>
                                        <div class="input-text">
                                            <input type="text" placeholder="berat hewan ternak" name="berat" required value="<?= $edit['berat']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-input">
